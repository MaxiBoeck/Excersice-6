...
a)  Briefly describe in one sentences what your R package does and why
    ...
    I like working with text thats why i imagined text minig package for a basic purpose to count all words in a given text.
    For that i worked out two text cleaning function and a word counting function.
...
# testing function
testthat::test_file("C:/Users/MaxiB/Desktop/FortStat Abgabe/Excersise Sheet 6/Excersice6/Tests/tests.R")
```
